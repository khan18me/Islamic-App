...
public class daytoday extends AppCompatActivity {
    ...
    private ArrayList<Pair<Integer, Integer>> getColors() {
        ...
        colors.add(Pair.create(ContextCompat.getColor(this, R.color.colorRed1), ContextCompat.getColor(this, R.color.colorBlue1)));
    ...
    private void light() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            getWindow().setNavigationBarColor(ContextCompat.getColor(this, R.color.lightWhite));
        }
    }
}